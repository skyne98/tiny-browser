(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
        typeof define === 'function' && define.amd ? define(['exports'], factory) :
            (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.linkedom = {}));
    ...
    const queueAttribute = (
        ...
        if ((!attributeFilter || attributeFilter.includes(attributeName))) {
            ...
            records.push(createRecord(
                'attributes', target,
                [], [],
                attributeName, attributeOldValue ? oldValue : undefined
            ));
            if (!scheduled) {
    ...
    */
    ...
    function compileRules(rules, options, context) {
        ...
        return rules.reduce((previous, rule) => previous === boolbase$1.falseFunc
            ? boolbase$1.falseFunc
            : compileGeneralSelector(previous, rule, options, context, compileToken), (_a = options.rootFunc) !== null && _a !== undefined ? _a : boolbase$1.trueFunc);
    }
